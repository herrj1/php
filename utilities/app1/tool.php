...
function display_select($sth,$q){
 ...
 $sqldr.="<div><table id='res' class='table table-bordered'>";
 $headers="<tr class='h'>";
...
<!DOCTYPE html>
<html>
<head><title>FAUCapture SQL Web Querying</title>
<meta charset="utf-8">
...
<?php echo $z?>&shex=1' class="btn btn-success">export</a>
<?php echo $z?>&shim=1' class='btn btn-info'>import</a>
<?php } ?>
...
<div class="col-md-12">
<label for="qraw"><b>FAUCapture SQL-Web Tool</b> <i>(separate queries with ";")</i>:</label>&nbsp;
